...
# Cleaning raw file to get the 2010 Census population by state 
us_pop <- select(us_pop_raw, X, Census)
us_pop <- us_pop %>% rename('State' = 'X', 'Population' = 'Census')
